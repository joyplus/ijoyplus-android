...
public class Media implements Comparable<Media> {
	...
	static {
		String[] video_extensions = { ".3g2", ".3gp", ".3gp2", ".3gpp", ".amv",
				...
				".gxf", ".iso", ".m1v", ".m2v", ".m2t", ".m2ts", ".m4v",
				".mkv", ".mov", ".mp2", ".mp2v", ".mp4", ".mp4v", ".mpe",
		...
		String[] audio_extensions = { ".3ga", ".a52", ".aac", ".ac3", ".adt",
				...
				".awb", ".caf", ".dts", ".flac", ".it", ".m4a", ".m4p", ".mid",
				".mka", ".mlp", ".mod", ".mpa", ".mp1", ".mp2", ".mp3", ".mpc",
				".oga", ".ogg", ".oma", ".opus", ".ra", ".ram", ".rmi", ".s3m",
				".spx", ".tta", ".voc", ".vqf", ".w64", ".wav", ".wma", ".wv",
				".xa", ".xm" };
	...
	public Media(String URI, Boolean addToDb) {
		...
		if (addToDb) {
			...
			DatabaseManager db = DatabaseManager.getInstance(App
					.getAppContext());
			db.addMedia(this);
		}
	}
	...
	public Media(Context context, String location, long time, long length,
			int type, Bitmap picture, String title, String artist,
			String genre, String album, int width, int height, String artworkURL) {
		mLocation = location;
		mFilename = null;
		mTime = time;
		mLength = length;
	...
	public int compareTo(Media another) {
		return mTitle.toUpperCase().compareTo(another.getTitle().toUpperCase());
	}
	...
	public Bitmap getPicture() {
		...
		if (mPicture == null) {
			...
			if (picture == null) {
				...
				picture = DatabaseManager.getInstance(c).getPicture(c,
						mLocation);
	...
	public void setPicture(Context context, Bitmap p) {
		...
		DatabaseManager.getInstance(context).updateMedia(mLocation,
				DatabaseManager.mediaColumn.MEDIA_PICTURE, p);
	...
	public String getGenre() {
		if (mGenre == App.getAppContext().getString(R.string.unknown_genre))
			return mGenre;
		else
			/* Make genres case insensitive via normalisation */
			return Character.toUpperCase(mGenre.charAt(0))
					+ mGenre.substring(1).toLowerCase();
	}
