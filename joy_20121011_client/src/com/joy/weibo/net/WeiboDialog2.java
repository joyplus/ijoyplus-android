...
//    public WeiboDialog2(final Weibo weibo, Context context, String url, WeiboDialogListener listener) {
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        mWeibo = getThird_AccessToken.getWeibo();
...
//                LayoutParams.FILL_PARENT));
    ...
    private void setUpWebView() {
       // webViewContainer = new RelativeLayout(getContext());
        ...
        mWebView.loadUrl(getThird_AccessToken.geturl());
        mListener = getThird_AccessToken.getWeiboDialogListener();
