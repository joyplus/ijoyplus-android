...
*/
        ...
        mDlna = (ImageButton) findViewById(R.id.player_with_dlna);
        mDlna.setOnClickListener(mDlnaListener);
...
//mDlnaListener
    private final OnClickListener mDlnaListener = new OnClickListener() {
...
*/
        ...
        mTitle.setText(title.substring(title.lastIndexOf("/") + 1));
    }
    private void CallDLNAPlayer() {
  		Intent intent = new Intent(this,dlna_main.class); 
  		intent.putExtra("meta", mLocation);
  		intent.putExtra("url", mLocation);
	            try {
