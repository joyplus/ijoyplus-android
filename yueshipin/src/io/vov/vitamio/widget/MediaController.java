...
public class MediaController extends FrameLayout {
	...
	private void updateBottomRight() {
		...
		// //
		// mWindowBottomRight.showAtLocation(mRoot.findViewById(R.id.imageButton5),
		// Gravity.RIGHT
		// // | Gravity.BOTTOM, 0, 0);
		//
		// }
	...
	private void updateTopRight() {
		...
		// mWindowTopRight.showAtLocation(mAnchor, Gravity.RIGHT|Gravity.TOP,
		// 25, 70);
		// //
		// mWindowTopRight.showAtLocation(mRoot.findViewById(R.id.imageButton6),
		// Gravity.RIGHT
		// // | Gravity.TOP, 0, 0);
		// }
		// if (mViewTopRight.getVisibility() == View.VISIBLE)
	...
	public class GroupAdapter extends BaseAdapter {
		...
		/**
		 * 启动一个异步任务，把网络相关放在此任务中 重定向新的链接，直到拿到资源URL
		 * 
