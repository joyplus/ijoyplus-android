	...
	public View getView(int i, View view, ViewGroup viewgroup) {
		...
		if (view1 == null) {
			...
			if(m_SearchListData.Is_Ready_Have)
				aq.id(R.id.button1).getImageView().setImageResource(R.drawable.search_addon_icon);
			aq.id(R.id.video_preview_img)
					.image(m_SearchListData.Pic_url, true, true, 0,
							R.drawable.default_image_bg);
			if (!isAddButton) {
				aq.id(R.id.button1).gone();
			} 
//			else {
//				ImageButton click = (ImageButton) view1.findViewById(R.id.button1);
//				click.setTag(i + "");
//			}
