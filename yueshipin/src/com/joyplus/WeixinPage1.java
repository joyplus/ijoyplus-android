...
public class WeixinPage1 extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.weixinpage1);
	...
	// 初始化list数据函数
		public void InitBangDanData(String url, JSONObject json, AjaxStatus status) {
			if (status.getCode() == AjaxStatus.NETWORK_ERROR) {
			...
			try {
				...
				{
					BangDan_id = m_ReturnTops.tops[0].id;
					CheckSaveData();
				}
			} catch (JsonParseException e) {
				// TODO Auto-generated catch block
