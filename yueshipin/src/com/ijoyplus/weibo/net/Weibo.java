 ...
 */
package com.ijoyplus.weibo.net;
...
import com.ijoyplus.App;
import com.ijoyplus.Constant;
...
public class Weibo {
	...
	private static String APP_KEY = Constant.SINA_CONSUMER_KEY;
	private static String APP_SECRET = Constant.SINA_CONSUMER_SECRET;
	...
	public String request(Context context, String url, WeiboParameters params,
		...
		System.out.println(url + "/" + httpMethod + "/" + params.toString()
	...
	public void dialog(Context context, WeiboParameters parameters,
		...
		if (context.checkCallingOrSelfPermission(Manifest.permission.INTERNET) != PackageManager.PERMISSION_GRANTED) {
			Utility.showAlert(context, "Error",
					"App requires permission to access the Internet");
		} else {
			/*
			 * WeiboDialog WeiboDialog = new WeiboDialog(this, context, url,
			 * listener); WeiboDialog.show();
			 */
			application = (App) context.getApplicationContext();
			application.setWeiboDialogListener(listener);
			application.seturl(url);
			application.setWeibo(this);
