 ...
 * 分类导航详情的数据适配器
 * */
public class Tab1GridAdapter extends ArrayAdapter {
	...
	// 构造函数
	public Tab1GridAdapter(Activity activity, List list) {
	...
	public View getView(int i, View view, ViewGroup viewgroup) {
		...
		if (view1 == null) {
			...
			view1 = ((Activity) getContext()).getLayoutInflater().inflate(
					R.layout.tab1_detail_grid, null);
			aq = new AQuery(view1);
			...
			aq.id(R.id.txt_video_caption).text(
					m_Tab1GridData.bucket_display_name);
