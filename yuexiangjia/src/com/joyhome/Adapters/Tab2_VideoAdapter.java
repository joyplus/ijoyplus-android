 ...
 * 分类导航详情的数据适配器
 * */
public class Tab2_VideoAdapter extends ArrayAdapter {
	...
	// 构造函数
	public Tab2_VideoAdapter(Activity activity, List list) {
	...
	public View getView(int i, View view, ViewGroup viewgroup) {
		...
		if (view1 == null) {
			...
			view1 = ((Activity) getContext()).getLayoutInflater().inflate(
					R.layout.video_detail_grid, null);
			aq = new AQuery(view1);

			// 获取当前数据项的数据
			Tab2GridData m_Tab2GridData = (Tab2GridData) getItem(i);

			aq.id(R.id.txt_video_caption).text(m_Tab2GridData.title);
